#include "../util/Util.h"
static log4cpp::Category& logger = Logger::getLogger("stub-svc/Authentication2");

#include "../stub/Authentication2.h"
#include "../stub/Service_Authentication2.h"

#include "../courier/Last.h"

bool        Courier::Stub::Service_Authentication2::isProcedureValid(int code) {
    switch(code) {
...
const char* Courier::Stub::Service_Authentication2::getProcedureName(int code) {
    switch(code) {
    case GetStrongCredentials::CODE:
...
void Courier::Stub::Service_Authentication2::service(const CallMessage& callMessage, Block& request, Block& response) {
...
void Courier::Stub::Service_Authentication2::callGetStrongCredentials(const CallMessage& callMessage, Block& request, Block& response) {
    try {
    ...
    } catch(const Authentication2::CallError& e) {
...
void Courier::Stub::Service_Authentication2::callCheckSimpleCredentials(const CallMessage& callMessage, Block& request, Block& response) {
    try {
        ...
        Courier::serialize(response, protocol3);
        Courier::serialize(response, result);
    } catch(const Authentication2::AuthenticationError& e) {
        Protocol::Protocol3 protocol3 = Courier::Service::getProtocolAbort(callMessage, e.abortCode);
        Courier::serialize(response, protocol3);
        Courier::serialize(response, e);
    } catch(const Authentication2::CallError& e) {
...
void Courier::Stub::Service_Authentication2::callCreateStrongKey(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Authentication2::callChangeStrongKey(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Authentication2::callDeleteStrongKey(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Authentication2::callCreateSimpleKey(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Authentication2::callChangeSimpleKey(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Authentication2::callDeleteSimpleKey(const CallMessage& callMessage, Block& request, Block& response) {
    try {
