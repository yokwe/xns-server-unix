#include "../util/Util.h"
static log4cpp::Category& logger = Logger::getLogger("stub-svc/Clearinghouse2");

#include "../stub/Clearinghouse2.h"
#include "../stub/Service_Clearinghouse2.h"

#include "../courier/Last.h"

bool        Courier::Stub::Service_Clearinghouse2::isProcedureValid(int code) {
    switch(code) {
...
const char* Courier::Stub::Service_Clearinghouse2::getProcedureName(int code) {
    switch(code) {
    case RetrieveAddresses::CODE:
...
void Courier::Stub::Service_Clearinghouse2::service(const CallMessage& callMessage, Block& request, Block& response) {
...
void Courier::Stub::Service_Clearinghouse2::callRetrieveAddresses(const CallMessage& callMessage, Block& request, Block& response) {
    try {
    ...
    } catch(const Clearinghouse2::CallError& e) {
...
void Courier::Stub::Service_Clearinghouse2::callListDomainServed(const CallMessage& callMessage, Block& request, Block& response) {
    try {
        ...
        Courier::serialize(response, protocol3);
        Courier::serialize(response, result);
    } catch(const Clearinghouse2::AuthenticationError& e) {
        Protocol::Protocol3 protocol3 = Courier::Service::getProtocolAbort(callMessage, e.abortCode);
        Courier::serialize(response, protocol3);
        Courier::serialize(response, e);
    } catch(const Clearinghouse2::CallError& e) {
...
void Courier::Stub::Service_Clearinghouse2::callCreateObject(const CallMessage& callMessage, Block& request, Block& response) {
    try {
        ...
        Courier::serialize(response, protocol3);
        Courier::serialize(response, result);
    } catch(const Clearinghouse2::ArgumentError& e) {
        Protocol::Protocol3 protocol3 = Courier::Service::getProtocolAbort(callMessage, e.abortCode);
        Courier::serialize(response, protocol3);
        Courier::serialize(response, e);
    } catch(const Clearinghouse2::AuthenticationError& e) {
        ...
        Courier::serialize(response, protocol3);
        Courier::serialize(response, e);
    } catch(const Clearinghouse2::UpdateError& e) {
        Protocol::Protocol3 protocol3 = Courier::Service::getProtocolAbort(callMessage, e.abortCode);
        Courier::serialize(response, protocol3);
        Courier::serialize(response, e);
    } catch(const Clearinghouse2::WrongServer& e) {
        Protocol::Protocol3 protocol3 = Courier::Service::getProtocolAbort(callMessage, e.abortCode);
        Courier::serialize(response, protocol3);
        Courier::serialize(response, e);
    } catch(const Courier::Service::Abort& e) {
...
void Courier::Stub::Service_Clearinghouse2::callDeleteObject(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callLookupObject(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callListOrganizations(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callListDomain(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callListObjects(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callListAliases(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callListAliasesOf(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callCreateAlias(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callDeleteAlias(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callAddGroupProperty(const CallMessage& callMessage, Block& request, Block& response) {
    try {
        ...
        Courier::serialize(response, protocol3);
        Courier::serialize(response, e);
    } catch(const Clearinghouse2::PropertyError& e) {
        Protocol::Protocol3 protocol3 = Courier::Service::getProtocolAbort(callMessage, e.abortCode);
        Courier::serialize(response, protocol3);
        Courier::serialize(response, e);
    } catch(const Clearinghouse2::UpdateError& e) {
...
void Courier::Stub::Service_Clearinghouse2::callAddItemProperty(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callDeleteProperty(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callListProperties(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callRetrieveItem(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callChangeItem(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callRetrieveMembers(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callAddMember(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callAddSelf(const CallMessage& callMessage, Block& request, Block& response) {
    try {
        AddSelf::Param  param;
...
void Courier::Stub::Service_Clearinghouse2::callDeleteMember(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callDeleteSelf(const CallMessage& callMessage, Block& request, Block& response) {
    try {
...
void Courier::Stub::Service_Clearinghouse2::callIsMember(const CallMessage& callMessage, Block& request, Block& response) {
    try {
