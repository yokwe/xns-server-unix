...
Courier::Stub::BulkData1::Descriptor::Descriptor_null& Courier::Stub::BulkData1::Descriptor::null() const {
...
Courier::Stub::BulkData1::Descriptor::Descriptor_immediate& Courier::Stub::BulkData1::Descriptor::immediate() const {
    if (choiceTag == CHOICE_TAG::immediate) {
        return choice_immediate;
    } else {
...
Courier::Stub::BulkData1::Descriptor::Descriptor_passive& Courier::Stub::BulkData1::Descriptor::passive() const {
    if (choiceTag == CHOICE_TAG::passive) {
        return choice_passive;
    } else {
...
Courier::Stub::BulkData1::Descriptor::Descriptor_active& Courier::Stub::BulkData1::Descriptor::active() const {
